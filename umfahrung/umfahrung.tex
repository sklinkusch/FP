...
\mtram{} M17  & BHH $\xarwe{18}$ BFFO $\xarwe{6}$ Tk $\xarwe{5}$ BKLH $\xarwe{11}$ BSW $\xarwe{20}$ BADL                                                                            & t: 10, f/a: 20, n: 30      \\
...
\tram{} 61    & (BSW $\xarwe{17}$) BADL $\xarwe{6}$ BSPF $\xarwe{24}$ BFRH                                                                                                          & t: 20                      \\
...
{\bfseries Linie} & {\bfseries Fahrtweg} & {\bfseries Takt} \\
\hline
\mbus{} M43   & Beu/Beu $\xarwe{11}$ BJLB $\xarwe{6}$ PL $\xarwe{9}$ Bo $\xarwe{5}$ Rk $\xarwe{10}$ BTP $\xarwe{4}$ BOK/BOKS                                                                               & t: 5/10, f/a: 20, n: 30    \\
...
\xbus{} X21   & BWIN $\xarwe{6}$ BKBO $\xarwe{4}$ Sch $\xarwe{8}$ JK $\xarwe{4}$ BJUN                                                                                                                & t: 10, f/a: 20             \\
\xbus{} X33   & BSPA $\xarwe{2}$ AS $\xarwe{3}$ Zi $\xarwe{2}$ Hs $\xarwe{17}$ Hh $\xarwe{8}$ RR $\xarwe{3}$ BWIN                                                                   & t: 6-10, f/a: 20           \\
\xbus{} X34   & BHST $\xarwe{2}$ Th $\xarwe{3}$ BMN $\xarwe{5}$ Wd $\xarwe{7}$ BZOS                                                                                                 & t: 10, f/a: 20, So: 20     \\
...
{\bfseries Linie} & {\bfseries Fahrtweg} & {\bfseries Takt} \\
\hline
\xbus{} X49   & BHST $\xarwe{2}$ Th $\xarwe{3}$ BMN $\xarwe{4}$ BCHS                                                                                                 & H: 10-20, Sa/So: --        \\
...
\bus{} 143    & Nd $\xarwe{4}$ Th $\xarwe{7}$ BHAL $\xarwe{8}$ Fpo $\xarwe{2}$ Bli $\xarwe{3}$ Beo $\xarwe{8}$ BIP $\xarwe{3}$ BFRU & t: 20 \\
...
\bus{} 158    & BBU $\xarwe{47}$ BGSS                                                                                            & t: 20 \\
...
\nbus{} N42   & BSKR $\xarwe{10}$ PL $\xarwe{7}$ Me $\xarwe{2}$ Ho $\xarwe{6}$ Sp $\xarwe{3}$ RHO $\xarwe{2}$   %
                BHKM $\xarwe{2}$ W $\xarwe{2}$ BALX                                                  & n: 30                      \\
\nbus{} N43   & Th $\xarwe{5}$ BHAL $\xarwe{8}$ Fpo $\xarwe{2}$ Bli $\xarwe{2}$ Beo & n: 30 \\
