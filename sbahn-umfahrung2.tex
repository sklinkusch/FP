...
\mtram{} M4   & BHH $\xarwe{18}$ BGSS $\xarwe{12}$ BALX $\xarwe{3}$ BHKM                                                                                                            & t: 5-10, f/a: 20, n: 30    \\
...
{\bfseries Linie} & {\bfseries Fahrtweg} & {\bfseries Takt} \\
\hline
\mbus{} M48   & BRST $\xarwe{4}$ Slo $\xarwe{2}$ Wsg $\xarwe{5}$ BIP $\xarwe{7}$ Kt $\xarwe{3}$ BS $\xarwe{1}$ Kus $\xarwe{8}$ BPOP $\xarwe{4}$ Mi $\xarwe{2}$ Sp $\xarwe{7}$ BALX  & t: 10, f/a: 20, n: 30      \\
...
\xbus{} TXL   & TXL $\xarwe{8}$ BBEU $\xarwe{6}$ Tm $\xarwe{6}$ BHBF $\xarwe{9}$ BTOR $\xarwe{2}$ ULO $\xarwe{2}$ MIN $\xarwe{4}$ BALX                                              & t: 6, f/a: 10              \\
...
\bus{} 200    & BZOS $\xarwe{14}$ BPOP $\xarwe{3}$ MH $\xarwe{4}$ ULO $\xarwe{2}$ MIN $\xarwe{5}$ BALX                                                                              & t: 10, f/a: 20             \\
...
\bus{} 248    & BWRS $\xarwe{6}$ BOSB $\xarwe{4}$ BJB $\xarwe{2}$ BALX $\xarwe{5}$ Sp $\xarwe{9}$ Ho $\xarwe{4}$ Gs $\xarwe{7}$ PL $\xarwe{9}$ BSKR ($\xarwe{4}$ BSGR $\xarwe{3}$ BIP %
                $\xarwe{4}$ BBUP $\xarwe{6}$ Bt, nur Mo-Sa tagsüber)                                                                                                                & t: 10-20, f/a: 20          \\
