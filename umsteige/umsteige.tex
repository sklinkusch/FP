...
\ifcorona
Adlershof                     &                 & BADL            &                 &
\snr{46} \snr{8} \snr{9} \tram 61 63 \bus 162 163 164 260                                                                                        &
\snr{46} \snr{8} \snr{9} \nbus N60 N65 N68                                                                                                       &
\nbus N60 N65 N68                                                                                                                                \\
\else
Adlershof                     &                 & BADL            &                 &
...
\nunr{2} \nunr{5} \nunr{8} \mtram M2 M4 M5 \nbus N40 N42 N65                                                                                     \\
                              &                 &                 &                 &
\mtram M2 M4 M5 M6 \bus 100 200 245 248 300                                                                                                      &
                                                                                                                                                 &
                                                                                                                                                 \\
\hline
Altstadt Spandau              &                 &                 & AS              &
...
\ifcorona
Baumschulenweg                &                 & BBMW            &                 &
\snr{46} \snr{47} \snr{8} \snr{9} \bus 170 265 365                                                                                               &
\snr{46} \snr{8} \snr{9} \nbus N70                                                                                                               &
\nbus N70                                                                                                                                        \\
\else
Baumschulenweg                &                 & BBMW            &                 &
...
\snr{1} \snr{2} \snr{25} \snr{8} \mtram M13 \tram 50                                                                                             &
...
\snr{1} \snr{2} \snr{25} \bus 100 245 \ped{} \bus 300                                                                                            &
\snr{1} \snr{2} \snr{25}                                                                                                                         &
                                                                                                                                                 \\
\else
Brandenburger Tor             &                 & BTOR            & BRT             &
\snr{1} \snr{2} \snr{25} \snr{26} \unr{55} \bus 100 245 \ped{} \bus 300                                                                          &
\snr{1} \snr{2} \snr{25}                                                                                                                         &
                                                                                                                                                 \\
\fi
\hline
...
\renr{7} \rbnr{14} \rbnr{22} \snr{9} \bus 163 164 171 734 735 736 738 741 742                                                                    &
\snr{9} \nunr{7} \nbus N60                                                                                                                       &
\nunr{7} \nbus N60                                                                                                                               \\
\else
Flughafen Schönefeld \flh         & BFHS            & BFLH            &                 &
...
\snr{5} \snr{7} \snr{75} \mtram M17 \tram 27 \bus 192 194                                                                                        &
...
\renr{1} \renr{2} \renr{7} \rbnr{14} \rbnr{21} \rbnr{22} \snr{1} \snr{2} \snr{25} \snr{3} \snr{5} \snr{7} \snr{9} \unr{6}                        &
\snr{1} \snr{2} \snr{25} \unr{6} \snr{7} \snr{9} \mtram M1                                                                                       &
\nunr{6} \mtram M1                                                                                                                               \\
                              &                 &                 &                 &
\mtram M1 \tram 12 \bus 147                                                                                                                      &
                                                                                                                                                 &
                                                                                                                                                 \\
\else
Friedrichstraße               & BFRI            & BFST, BFSTT     & F               &
...
\fbahn{} \renr{3} \renr{5} \renr{6} \snr{1} \snr{2} \snr{25} \snr{41} \snr{42} \snr{46} \unr{8} \bus 247                                         &
...
\ifcorona
Grünau                        &                 & BGAS            &                 &
\snr{46} \snr{8} \tram 68 \bus 163 263 363                                                                                                       &
\snr{46} \snr{8} \nbus N62 N68                                                                                                                   &
\nbus N62 N68                                                                                                                                    \\
\else
Grünau                        &                 & BGAS            &                 &
...
\mtram M10 \mbus M41 \nbus N20 N40                                                                                                               \\
                              &                 &                 &                 &
\mtram M5 M8 M10 \mbus M41 M85 \xbus TXL \bus 120 123 142 147 245                                                                                &
                                                                                                                                                 &
                                                                                                                                                 \\
\else
Hauptbahnhof                  & BLS, BL         & BHBF            & HBF             &
...
\ifcorona
Hellersdorf                   &                 &                 & Hd              &
\unr{5} \mtram M6 \xbus X54 \bus 195                                                                                                             &
\unr{5} \mtram M6                                                                                                                                &
\nunr{5} \mtram M6                                                                                                                               \\
\else
Hellersdorf                   &                 &                 & Hd              &
...
\renr{6} \rbnr{20} \snr{25} \bus 136 651 807 808 809 811 824 \ped{} \bus 814                                                                     &
\snr{25}                                                                                                                                         &
                                                                                                                                                 \\
\else
Hennigsdorf                   & BHND            & BHD             &                 &
...
\snr{41} \snr{42} \snr{46} \snr{47} \unr{8} \mbus M44 \bus 246 277 370 377                                                                       &
...
\ifcorona
Humboldthain                  &                 & BHUM            &                 &
\snr{1} \snr{2} \snr{25} \bus 247 \ped{} \mbus M27                                                                                               &
...
\ifcorona
Karlshorst                    & BKH             & BKLH            &                 &
\snr{3} \mtram M17 \tram 27 \bus 296 396                                                                                                         &
\snr{3} \mtram M17                                                                                                                               &
\mtram M17                                                                                                                                       \\
\else
Karlshorst                    & BKH             & BKLH            &                 &
...
\snr{46} \snr{47} \mbus M41 \bus 341 \ped{} \bus 377                                                                                             &
\snr{46} \mbus M41 \ped{} \nbus N77                                                                                                              &
\mbus M41 \ped{} \nbus N77                                                                                                                       \\
\else
Köllnische Heide              &                 & BKHD            &                 &
...
\snr{41} \snr{42} \snr{8} \mtram M5 M6 M8 \bus 156                                                                                               &
...
\ifcorona
Lankwitz                      &                 & BLAK            &                 &
\snr{25} \mbus M82 \xbus X83 \bus 181 187 283 284 \ped{} \bus 184 284                                                                            &
\snr{25} \mbus M82 \nbus N81 \ped{} N84                                                                                                          &
\mbus M82 \nbus N81 \ped{} N84                                                                                                                   \\
\else
Lankwitz                      &                 & BLAK            &                 &
...
\fbahn{} \rbnr{12} \rbnr{24} \rbnr{25} \rbnr{26} \snr{5} \snr{7} \snr{75} \unr{5} \tram 21 \bus 108 240 256 296                                  &
...
\renr{3} \renr{4} \renr{5} \snr{25} \mbus M11 \xbus X11 \bus 184 284 \ped{} \bus 380                                                             &
\snr{25} \mbus M11 \nbus N84                                                                                                                     &
\mbus M11 \nbus N84                                                                                                                              \\
\else
Lichterfelde Ost              & BLIH            & BLIO            &                 &
...
\ifcorona
Marzahn                       &                 & BMAZ            &                 &
\snr{7} \mtram M6 \xbus X54 \bus 191 192 195 291                                                                                                 &
\snr{7} \mtram M6                                                                                                                                &
\mtram M6                                                                                                                                        \\
\else
Marzahn                       &                 & BMAZ            &                 &
...
\ifcorona
Neukölln                      &                 & BNK             & Nk              &
\snr{41} \snr{42} \snr{46} \snr{47} \unr{7} \bus 171 370 377                                                                                     &
...
\ifcorona
Nordbahnhof                   &                 & BNB             &                 &
\snr{1} \snr{2} \snr{25} \mtram M8 M10 \tram 12 \bus 247                                                                                         &
...
\snr{1} \snr{2} \snr{25} \mtram M1 M5                                                                                                            &
...
\ifcorona
Pankow                        &                 & BPKW            & PA              &
\snr{2} \snr{8} \unr{2} \mtram M1 \tram 50 \mbus M27 \xbus X54 \bus 155 250 255                                                                  &
...
\ifcorona
Plänterwald                   &                 & BPWA            &                 &
\snr{8} \snr{9} \bus 165 166 377 \ped{} \bus 265                                                                                                 &
\snr{8} \snr{9} \nbus N65 N77                                                                                                                    &
\nbus N65 N77                                                                                                                                    \\
\else
Plänterwald                   &                 & BPWA            &                 &
...
\renr{1} \rbnr{20} \rbnr{21} \rbnr{22} \rbnr{23} \tram 91 94 \bus 580 605 606 610 631                                                            &
\nbus N14                                                                                                                                        &
\nbus N14                                                                                                                                        \\
\else
Potsdam Charlottenhof         & BPDC            &                 &                 &
...
\renr{1} \rbnr{20} \rbnr{21} \rbnr{22} \rbnr{23} \snr{7} \tram 91 92 93 96 99 \xbus X1 \bus 580                                                  &
\snr{7} \bus 607 611 631 \nbus N13 N14 N15 N16 N17 N43                                                                                           &
\nbus N13 N14 N16 N17                                                                                                                            \\
                              &                 &                 &                 &
601 603 604 605 606 607 608 611 614 619 631 638 643 650 690 691 694 695 715 750                                                                  &
                                                                                                                                                 &
                                                                                                                                                 \\
\else
Potsdam Hauptbahnhof          & BPD             & BPDH            &                 &
...
\renr{7} \rbnr{33} \tram 91 93 \bus 602 611 693 699 750                                                                                          &
\nbus N14                                                                                                                                        &
\nbus N14                                                                                                                                        \\
\else
Potsdam Rehbrücke             & BRC             &                 &                 &
...
\renr{3} \renr{4} \renr{5} \rbnr{10} \snr{1} \snr{2} \snr{25} \unr{2} \mbus M41 M48 M85 \bus 200 300                                             &
...
\snr{41} \snr{42} \snr{8} \mtram M2 \bus 156                                                                                                     &
...
\ifcorona
Priesterweg                   &                 & BPRS            &                 &
\snr{2} \snr{25} \mbus M76 \xbus X76 \bus 170 246                                                                                                &
...
\rbnr{24} \snr{46} \snr{47} \snr{8} \snr{9} \mtram M17 \tram 21 60 \mbus M11 \xbus X11                                                           &
\snr{46} \snr{47} \snr{8} \snr{9} \mtram M17 \mbus M11 \nbus N65 N67                                                                             &
\mtram M17 \mbus M11 \nbus N65 N67                                                                                                               \\
                              &                 &                 &                 &
\bus 160 163 165 166 265                                                                                                               &
                                                                                                                                                 &
                                                                                                                                                 \\
\else
Schöneweide                   & BSWP            & BSW             &                 &
...
\ifcorona
Schönholz                     &                 & BSNH            &                 &
\snr{1} \snr{25} \bus 150 327 \ped{} \bus 155                                                                                                    &
\snr{1} \snr{2} \nbus N52                                                                                                                        &
\nbus N52                                                                                                                                        \\
\else
Schönholz                     &                 & BSNH            &                 &
...
\snr{41} \snr{42} \snr{8} \bus 156 240 \ped{} \tram 21                                                                                           &
\snr{41} \snr{42} \snr{8}                                                                                                                        &
                                                                                                                                                 \\
\else
Storkower Straße              &                 & BSTO            &                 &
...
\snr{25} \bus 282 \ped{} \snr{2} \bus 184                                                                                                        &
\snr{25} \ped{} \snr{2} \nbus N84                                                                                                                &
\ped{} \nbus N84                                                                                                                                 \\
\else
Südende                       &                 & BSDE \ped{} BATS &                 &
...
\fbahn{} \renr{3} \renr{4} \renr{5} \rbnr{10} \snr{2} \snr{25} \snr{41} \snr{42} \snr{46} \mbus M46 \bus 106 184 204 248                         &
...
\ifcorona
Teltow Stadt                  &                 & BTLS            &                 &
\snr{25} \xbus X1 X10 \bus 600 601 615 620 621 625 626 704                                                                                       &
\snr{25} \nbus N13                                                                                                                               &
\nbus N13                                                                                                                                        \\
\else
Teltow Stadt                  &                 & BTLS            &                 &
...
\ifcorona
Tempelhof                     &                 & BTHF            & Ts              &
\snr{41} \snr{42} \snr{46} \unr{6} \bus 140 184                                                                                                  &
...
\ifcorona
Tierpark                      &                 &                 & Tk              &
\unr{5} \mtram M17 \tram 27 \bus 296                                                                                                             &
\unr{5} \mtram M17 \nbus 50                                                                                                                      &
\mtram M17 \nbus 50                                                                                                                              \\
\else
Tierpark                      &                 &                 & Tk              &
...
\ifcorona
Treptower Park                &                 & BTP             &                 &
\snr{41} \snr{42} \snr{8} \snr{9} \bus 104 165 166 194 265                                                                                       &
...
\bus 100 147 245 300 \ped{} \unr{6}                                                                                                              &
\ped{} \unr{6}                                                                                                                                   &
\nunr{6}                                                                                                                                         \\
\hline
\ifcorona
Velten                        & BVLT            &                 &                 &
\renr{6} \bus 807 816 824                                                                                                                        &
                                                                                                                                                 &
                                                                                                                                                 \\
\else
Velten                        & BVLT            &                 &                 &
...
\ifcorona
Waidmannslust                 &                 & BWAI            &                 &
\snr{1} \bus 222 322 \ped{} \bus 122 220                                                                                                         &
\snr{1} \nbus N22 \ped{} \nbus N20                                                                                                               &
\nbus N22 \ped{} \nbus N20                                                                                                                       \\
\else
Waidmannslust                 &                 & BWAI            &                 &
...
\ifcorona
Wittenau                      &                 & BWIN            & WIU             &
\snr{1} \unr{8} \mbus M21 \xbus X21 X33 \bus 120 122 124 220 221                                                                                 &
...
\ifcorona
Wollankstraße                 &                 & BWOK            &                 &
\snr{1} \snr{25} \mbus M27 \bus 250 255                                                                                                          &
